    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs maintitle="Dashboard" title="현장개선반" breadcrumbItem="현장인재육성" />소분류이동
          <Row>
            <Col xl={12} md={6}>
              <Card className="mini-stat bg-primary text-white">
                <CardBody>
                  <div className="mb-4">
                    ...
                    <Link to="/logout" className="dropdown-item"> <p className="text-white-50 mb-0 mt-1">소분류 이동</p></Link>
                    </div>
                  </div>
                  <div className="pt-2">
                    <div className="float-end">
                      <Link to="#" className="text-white-50">소분류로 이동
