                    ...
                    <div>
                      {files.map((file, index) => (
                       /*  <div key={index} style={{ display: 'flex', alignItems: 'center' }}> */
                          ...
                          <div className="float-end me-0 md-1"> 
                       {/*    <button  className="waves-effect waves-light btn btn-outline-danger" onClick={() => deleteFile(index)}>    </button>   */}
                          <button className="waves-effect waves-light btn btn-outline-danger" onClick={() => deleteFile(index)}><i className="mdi mdi-trash-can-outline"></i></button>
...
<div style={{ display: 'flex', justifyContent: 'space-between' }}>
      <button>버튼 1</button>
      <button style={{ marginLeft: 'auto' }}>버튼 2</button>
    </div>
</Row>
                <Row>

                <div className="mt-2"  style={{ display: 'flex', justifyContent: 'center' }}>
                  <Button  className="btn btn-secondary me-2 md-1" style={{ marginRight: '10px' }}>이미지 찾기</Button>
