...
const [isExpanded, setIsExpanded] = useState(true);
  const [containerSize, setContainerSize] = useState({ width: '500px', height: '300px' });

  const handleToggle = () => {
    setIsExpanded(!isExpanded);
    setContainerSize(isExpanded ? { width: '300px', height: '200px' } : { width: '500px', height: '300px' });
  };
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid={true}>
          ...
          <div
      className={`container ${isExpanded ? 'expanded' : 'collapsed'}`}
