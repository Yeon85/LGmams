...
import 'ag-grid-community/styles/ag-theme-alpine.css';
  ...
  const Calender = props => {
    ...
    const itemList = [
      ...
      { name: '소고기', category: '고기' },
      { name: '양파', category: '채소' },
      { name: '닭고기', category: '고기' },
    ];  
  ...
  const columnDefs = [
    {
      ...
      filterParams: {
        values: selectOptions.map(option => option.value),
        cellRenderer: 'selectFilterRenderer',
        suppressMiniFilter: true, // 셀 클릭 시 필터링 패널 열림 방지
      },
    },
    // 다른 컬럼 정의들...
  ];
