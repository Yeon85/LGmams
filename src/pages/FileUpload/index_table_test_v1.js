...
<MDBDataTableV5 hover entriesOptions={[5, 20, 25]} entries={5} pagesAmount={4} data={data} fullPagination />;
                ...
                <Col lg={3}>
                  <div className="card">
                    <div className="card-body">
                      <MDBDataTable 
                        noBottomColumns={true} 
                       responsive bordered hover={true} onClick={toggleCategory} data={data_2} />
                    </div>
                   </div>                     
                </Col>
              </Row>
