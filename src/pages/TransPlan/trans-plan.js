...
/*   const handleYearChange = (e) => {
  ...
  const [todos, setTodos] = useState([
    { id: 1, text: '할 일 1', category: 'todo' },
    { id: 2, text: '할 일 2', category: 'inProgress' },
    { id: 3, text: '할 일 3', category: 'done' }
  ]);
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid={true}>
          {/* Render Breadcrumb */}
          <Breadcrumbs maintitle="자율운영"  title="작업시간준수" breadcrumbItem="감독자 교육 계획 관리" />
          <Row>
                  ...
                  <Col md="4">
                    ...
                    <Row>
                      ...
                      <MDBDataTableV5  //responsive bordered 
                        hover  searchBottom={false} entriesOptions={[10, 20, 50, 100]}  
                        //pagingTop
                        searchTop
                        searchLabel="검색:"
        ...
        {todos
          ...
          .map(todo => (
            <div
              ...
              draggable
              onDragStart={() => moveTodo(todo.id, 'inProgress')}
            >
              {todo.text}
            </div>
          ))}
        ...
        {todos
          ...
          .map(todo => (
            <div
              ...
              className="kanban-card"
              draggable
              onDragStart={() => moveTodo(todo.id, 'done')}
            >
              {todo.text}
            </div>
          ))}
