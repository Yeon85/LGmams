  ...
  return (
    <Row className="align-items-center">
      ...
      <Col sm={6}>
        ...
        <div color="primary" className="btn btn-primary dropdown-toggle waves-effect waves-light me-2">
        <Link to="/logout" className="dropdown-item text-white">
          <i className="ti-search me-2"/>Search
          </Link> 
          
            </div>
        <div color="primary" className="btn btn-primary dropdown-toggle waves-effect waves-light me-2">
          <Link to="/logout" className="dropdown-item text-white">
          <i className="ti-file me-2"/>NEW
          </Link> 
        </div>   
        <div color="primary" className="btn btn-primary dropdown-toggle waves-effect waves-light me-2">
          <Link to="/logout" className="dropdown-item text-white">
          <i className="ti-save me-2"/>SAVE
          </Link> 
        </div>  
        <div color="primary" className="btn btn-primary dropdown-toggle waves-effect waves-light me-2">
          <Link to="/logout" className="dropdown-item text-white">
          <i className="dripicons-trash me-2"/>DELETE
          </Link> 
        </div>     
        </div>    
        {/* <div className="float-end d-none d-md-block">
